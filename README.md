...
[![build-terrafirma](https://github.com/areif-dev/terrafirma/actions/workflows/build.yml/badge.svg)](https://github.com/areif-dev/terrafirma/actions/workflows/build.yml)
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/areif-dev/terrafirma-<wm>:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/areif-dev/terrafirma-<wm>:latest
  ```
...
```
rpm-ostree rebase ostree-image-signed:docker://ghcr.io/areif-dev/terrafirma-<wm>:20230403
```
